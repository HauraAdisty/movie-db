...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.D:\SEMESTER4\web_laravel\movie-db\public\storage' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.D:\\SEMESTER4\\web_laravel\\movie-db\\public\\storage','logging.default','logging.deprecations.channel',
...
'web','api',);
        registerArgumentsSet('routes', 'movies.index','movies.search','movie.index','movie.store','movie.show','movie.edit','movie.update',
'movie.destroy','login','login.post','logout',
'storage.local',);
        registerArgumentsSet('views', 
'homepage','layouts.footer','layouts.header','layouts.main','layouts.template',
'login','movie.index','movie_detail','movie_form','welcome',
